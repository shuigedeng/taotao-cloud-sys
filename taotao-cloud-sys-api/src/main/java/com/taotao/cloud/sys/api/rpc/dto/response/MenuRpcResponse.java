 ...
 */
@RecordBuilder
public record MenuRpcResponse(Long id, String name, int type, String perms, String path, String component,
							  long parentId, String icon, boolean keepAlive, boolean hidden, boolean alwaysShow,
							  String redirect, boolean isFrame, int sortNum, LocalDateTime createTime,
							  LocalDateTime lastModifiedTime)
	implements MarkerResponse {

	@Serial
	private final static long serialVersionUID = 5126530068827085130L;
