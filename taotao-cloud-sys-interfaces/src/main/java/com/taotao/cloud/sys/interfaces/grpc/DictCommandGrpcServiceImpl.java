...
import com.taotao.cloud.sys.api.grpc.DictCommandGrpcServiceGrpc;
import com.taotao.cloud.sys.api.grpc.DictQueryGrpcServiceGrpc;
import com.taotao.cloud.sys.api.grpc.dto.command.CreateDictGrpcCommand;
...
@GrpcService
public class DictCommandGrpcServiceImpl extends DictCommandGrpcServiceGrpc.DictCommandGrpcServiceImplBase {

	private final DictQueryService dictQueryService;
	private final DictCommandService dictCommandService;

	@Override
	public void create(CreateDictGrpcCommand request, StreamObserver<DictGrpcResponse> responseObserver) {
		DictGrpcResponse result = DictGrpcResponse.newBuilder().build();
