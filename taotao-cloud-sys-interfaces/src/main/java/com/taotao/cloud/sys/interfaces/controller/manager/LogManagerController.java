...
@RequestMapping("/log")
public class LogManagerController extends BusinessController {
    ...
    //    public void download(HttpServletResponse response, LogQueryCriteria criteria) throws
    // IOException {
    ...
    //    @PreAuthorize("@el.check('admin','log:list')")
    //    public void errorDownload(HttpServletResponse response, LogQueryCriteria criteria) throws
    // IOException {
