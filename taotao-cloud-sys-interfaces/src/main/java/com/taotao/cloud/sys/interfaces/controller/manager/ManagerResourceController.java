...
public class ManagerResourceController extends BusinessController {
    ...
    //    @SentinelResource(value = "findResourceByRoleId", blockHandler =
    // "findResourceByRoleIdException")
    //    @GetMapping("/roleId/{roleId}")
    //    public Result<List<MenuQueryVO>> getResourceByRoleId(@NotNull(message = "角色id不能为空")
    ...
    //    @Parameters({
    //            @Parameter(name = "roleIds", description = "角色id列表", required = true, example =
    // "1,2,3")
    //    })
    //    @RequestLogger
    //    @PreAuthorize("hasAuthority('sys:resource:info:roleIds')")
    //    @GetMapping("/roleIds")
    //    public Result<List<MenuQueryVO>> getResourceByRoleIds(@NotEmpty(message = "角色id列表不能为空")
    ...
    //    @Parameters({
    //            @Parameter(name = "code", description = "角色code", required = true, example = "1",
    // in = ParameterIn.PATH)
    //    })
    //    @RequestLogger
    //    @PreAuthorize("hasAuthority('sys:resource:info:code')")
    //    @GetMapping("/code/{code}")
    //    public Result<List<MenuQueryVO>> findResourceByCode(@NotBlank(message = "角色code不能为空")
    ...
    //    @Parameters({
    //            @Parameter(name = "codes", description = "角色cde列表", required = true, example =
    // "1,2,3")
    //    })
    //    @RequestLogger
    //    @PreAuthorize("hasAuthority('sys:resource:info:codes')")
    //    @GetMapping("/codes")
    //    public Result<List<MenuQueryVO>> findResourceByCodes(@NotNull(message = "角色cde列表不能为空")
    ...
    //    @Parameters({
    //            @Parameter(name = "parentId", description = "父id", required = false, example =
    // "1")
    //    })
    //    @RequestLogger
    //    @PreAuthorize("hasAuthority('sys:resource:current:user:tree')")
    //    @GetMapping("/current/user/tree")
    //    public Result<List<MenuTreeVO>> findCurrentUserResourceTree(@RequestParam(value =
    // "parentId", required = false) Long parentId) {
    //        Set<String> roleCodes = SecurityUtils.getCurrentUser().getRoleCodes();
    //        if (CollUtil.isEmpty(roleCodes)) {
    ...
    //    @Parameters({
    //            @Parameter(name = "lazy", description = "是否是延迟查询", required = false, example =
    // "true,false"),
    //            @Parameter(name = "parentId", description = "父id", required = false, example =
    // "1")
    //    })
    ...
    //    public Result<List<MenuTreeVO>> findResourceTree(@RequestParam(value = "lazy", required =
    // false) Boolean lazy,
    ...
    //    // public Result<Boolean> testSeata(HttpServletRequest request, HttpServletResponse
    // response) {
