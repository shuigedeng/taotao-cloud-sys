...
public class ManagerMonitorController extends BusinessController {
    ...
    //		List<OnlineUserInfo> onlineUserList = monitorApplicationService.getOnlineUserList(userName,
    // ipaddr);
    ...
    //			@ApiFormParam(name = "pageNo", description = "页码", example = "1", type = "integer",
    // required = true, check = true),
    //			@ApiFormParam(name = "pageSize", description = "页大小", example = "10", type = "integer",
    // required = true, check = true)
    //		}
    //	)
    //	@ApiResponses
    //	@SaCheckRole("sysadmin")
    //	public Result<?> list(@Param("serviceNameParam") String serviceNameParam,
    // @Param("groupNameParam") String groupNameParam, @Param("pageNo") int pageNo,
    ...
    //	@ApiResponses
    //	@SaCheckRole("sysadmin")
    //	public Result<?> service(@Param("serviceName") String serviceName, @Param("groupName") String
    // groupName) {
    //		return Result.error();
    //	}
}
