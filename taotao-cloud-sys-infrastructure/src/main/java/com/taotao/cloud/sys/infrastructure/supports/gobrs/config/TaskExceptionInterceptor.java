...
package com.taotao.cloud.sys.infrastructure.supports.gobrs.config;
 ...
 *
 * @program: gobrs -async-core @ClassName GobrsInterceptor
 * @description: 异常拦截器
 * @author: sizegang
 * @create: 2022 -03-20
 */
@Slf4j
@Component
public class TaskExceptionInterceptor implements AsyncTaskExceptionInterceptor {
