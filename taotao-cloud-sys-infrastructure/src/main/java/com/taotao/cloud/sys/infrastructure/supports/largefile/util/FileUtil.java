...
package com.taotao.cloud.sys.infrastructure.supports.largefile.util;
...
public class FileUtil extends FileUtils {
	...
	/**
	 * 不确定是否能准确，待测试 判断文本文件的字符集，文件开头三个字节表明编码格式。 <a
	 * href="http://blog.163.com/wf_shunqiziran/blog/static/176307209201258102217810/">参考的博客地址</a>
	 */
