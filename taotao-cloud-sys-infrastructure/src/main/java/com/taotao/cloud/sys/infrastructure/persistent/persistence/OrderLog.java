...
package com.taotao.cloud.sys.infrastructure.persistent.persistence;
//
...
//	}
//
//	public OrderLog(String siteId, Integer actionType, String operatorUserId,
//		String operatorUserName,
//		String operatorUserRoles, Integer operatorObjectType, String operatorObjectId,
//		String operatorObjectName,
...
//	}
//
//	public OrderLog(String siteId, Integer actionType, Integer operatorObjectType,
...
//		return new StringBuilder().append("主键[").append(getId()).append("],").append("站点ID[")
//			.append(getSiteId())
//			.append("],").append("操作类型 创建、编辑、删除、启用、禁用[").append(getActionType())
//			.append("],").append("操作人ID[")
//			.append(getOperatorUserId()).append("],").append("操作人当时名称[")
//			.append(getOperatorUserName()).append("],")
//			.append("操作人当时所属角色名称，逗号分割[").append(getOperatorUserRoles()).append("],")
//			.append("操作对象类型[")
//			.append(getOperatorObjectId()).append("],").append("操作对象当时的名称[")
//			.append(getOperatorObjectName())
//			.append("],").append("操作内容详情[").append(getActionContent()).append("],")
//			.append("记录创建人[")
//			.append(getCreateUserId()).append("],").append("记录创建时间[").append(getCreateTime())
//			.append("],")
//			.append("备用字段[").append(getBak1()).append("],").append("备用字段[")
//			.append(getBak2()).append("],")
//			.append("备用字段[").append(getBak3()).append("],").append("备用字段[")
//			.append(getBak4()).append("],")
