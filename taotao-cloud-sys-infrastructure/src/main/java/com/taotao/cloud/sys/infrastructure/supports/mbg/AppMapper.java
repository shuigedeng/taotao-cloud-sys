package com.taotao.cloud.sys.infrastructure.supports.mbg;

import static com.taotao.cloud.sys.biz.supports.mbg.AppDynamicSqlSupport.*;
import static org.mybatis.dynamic.sql.SqlBuilder.isEqualTo;

import com.taotao.cloud.sys.biz.supports.mbg.AppDynamicSqlSupport;
...
public interface AppMapper extends CommonSelectMapper, CommonCountMapper, CommonDeleteMapper, CommonUpdateMapper {
    ...
    int insert(InsertStatementProvider<AppDynamicSqlSupport.App> insertStatement);

    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    @InsertProvider(type=SqlProviderAdapter.class, method="insertMultipleWithGeneratedKeys")
    @Options(useGeneratedKeys=true,keyProperty="records.id")
    int insertMultiple(@Param("insertStatement") String insertStatement, @Param("records") List<AppDynamicSqlSupport.App> records);
    ...
    List<AppDynamicSqlSupport.App> selectMany(SelectStatementProvider selectStatement);

    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @ResultMap("AppResult")
    Optional<AppDynamicSqlSupport.App> selectOne(SelectStatementProvider selectStatement);
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default int insert(AppDynamicSqlSupport.App row) {
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default int insertMultiple(Collection<AppDynamicSqlSupport.App> records) {
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default int insertSelective(AppDynamicSqlSupport.App row) {
        return MyBatis3Utils.insert(this::insert, row, app, c ->
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default Optional<AppDynamicSqlSupport.App> selectOne(SelectDSLCompleter completer) {
        return MyBatis3Utils.selectOne(this::selectOne, selectList, app, completer);
    }

    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default List<AppDynamicSqlSupport.App> select(SelectDSLCompleter completer) {
        return MyBatis3Utils.selectList(this::selectMany, selectList, app, completer);
    }

    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default List<AppDynamicSqlSupport.App> selectDistinct(SelectDSLCompleter completer) {
        return MyBatis3Utils.selectDistinct(this::selectMany, selectList, app, completer);
    }

    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default Optional<AppDynamicSqlSupport.App> selectByPrimaryKey(Long id_) {
        return selectOne(c ->
            c.where(id, isEqualTo(id_))
        );
    }
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    static UpdateDSL<UpdateModel> updateAllColumns(AppDynamicSqlSupport.App row, UpdateDSL<UpdateModel> dsl) {
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    static UpdateDSL<UpdateModel> updateSelectiveColumns(AppDynamicSqlSupport.App row, UpdateDSL<UpdateModel> dsl) {
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default int updateByPrimaryKey(AppDynamicSqlSupport.App row) {
        return update(c ->
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default int updateByPrimaryKeySelective(AppDynamicSqlSupport.App row) {
        return update(c ->
