package com.taotao.cloud.sys.infrastructure.supports.grpc;
...
public class GreeterService extends LogGrpcServiceGrpc.LogGrpcServiceImplBase {
	...
	public void searchLog(LogRequest request, StreamObserver<Log> responseObserver) {
		Log log = Log.newBuilder().setType(1).setAddress("safasf").setCreatetime("salfdasfd").setId("111").setStatus(1).build();
