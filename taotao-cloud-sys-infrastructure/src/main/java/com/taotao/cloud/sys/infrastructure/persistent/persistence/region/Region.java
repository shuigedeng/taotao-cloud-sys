...
package com.taotao.cloud.sys.infrastructure.persistent.persistence.region;
...
@org.springframework.data.relational.core.mapping.Table(name = Region.TABLE_NAME, comment = "地区表")
