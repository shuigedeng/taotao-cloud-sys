...
public class MemberUserLoginLog {
    ...
    public MemberUserLoginLog() {}

    public MemberUserLoginLog(String id) {
        this.id = id;
    }
    ...
    public MemberUserLoginLog(
            ...
            String operatorUserRoles,
            Integer operatorObjectType,
    ...
    public String toString() {
        return new StringBuilder()
                ...
                .append(getSiteId())
                .append("],")
                .append("操作类型 创建、编辑、删除、启用、禁用[")
                .append(getActionType())
                .append("],")
                .append("操作人ID[")
                .append(getOperatorUserId())
                .append("],")
                .append("操作人当时名称[")
                .append(getOperatorUserName())
                .append("],")
                .append("操作人当时所属角色名称，逗号分割[")
                .append(getOperatorUserRoles())
                .append("],")
                .append("操作对象类型[")
                .append(getOperatorObjectId())
                .append("],")
                .append("操作对象当时的名称[")
                .append(getOperatorObjectName())
                .append("],")
                .append("操作内容详情[")
                .append(getActionContent())
                .append("],")
                .append("记录创建人[")
    ...
    public boolean equals(Object obj) {
        if (obj instanceof MemberUserLoginLog == false) {
            return false;
        }
        ...
        MemberUserLoginLog other = (MemberUserLoginLog) obj;
