...
echo "================================================"
echo "  taotao-cloud-sys 安全扫描"
echo "================================================"

# 扫描配置
BASE_DIR="."
MODULES=("taotao-cloud-sys-api" "taotao-cloud-sys-application" "taotao-cloud-sys-domain" "taotao-cloud-sys-infrastructure" "taotao-cloud-sys-interfaces")
HAS_WARNINGS=0
