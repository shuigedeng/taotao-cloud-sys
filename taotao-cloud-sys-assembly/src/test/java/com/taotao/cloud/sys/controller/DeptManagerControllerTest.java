...
import com.taotao.cloud.sys.interfaces.controller.manager.DeptManagerController;
 ...
 *
 * <p>验证 {@link DeptManagerController#tree()} 返回正常结果。
 */
class DeptManagerControllerTest extends TaoTaoCloudSysApplicationTests {

	@Autowired
	private DeptManagerController controller;
