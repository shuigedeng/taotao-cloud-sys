...
package com.taotao.cloud.sys.application.configuration.redis;
...
import com.taotao.cloud.sys.application.configuration.redis.delegate.DataVersionLogTopicMessageDelegate;
import com.taotao.cloud.sys.application.configuration.redis.delegate.RequestLogTopicMessageDelegate;
