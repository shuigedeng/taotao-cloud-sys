...
package com.taotao.cloud.sys.application.dto.resource.result;
...
public record ResourceResult(	@Schema(description = "菜单DTO")
	Integer menuId,
	...
	String redirect) implements MarkerResult {
