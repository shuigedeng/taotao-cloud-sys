...
package com.taotao.cloud.sys.application.dto.app.command;
...
public record CreateAppCommand(
	...
	@Schema(description = "图标") @NotNull(message = "图标不能为空!", groups = Groups.Create.class) String icon,
	@Schema(description = "排序") @NotNull(message = "排序不能为空!", groups = Groups.Create.class) Integer sort,
