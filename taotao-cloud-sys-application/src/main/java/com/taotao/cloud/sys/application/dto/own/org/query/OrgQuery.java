...
package com.taotao.cloud.sys.application.dto.own.org.query;
...
public record OrgQuery(@Schema(description = "租户id") String tenantId,
					   @Schema(description = "租户密钥") String tenantSecret,
					   @Schema(description = "公司名称") String name, @Schema(description = "企业全称") String fullName,
