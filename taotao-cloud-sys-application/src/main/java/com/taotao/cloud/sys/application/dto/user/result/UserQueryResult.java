...
package com.taotao.cloud.sys.application.dto.user.result;
...
public record UserQueryResult(@Schema(description = "id") Long id, @Schema(description = "昵称") String nickname,
							  @Schema(description = "真实用户名") String username,
							  @Schema(description = "手机号") String phone,
							  @Schema(description = "性别 1男 2女 0未知") Integer sex,
							  @Schema(description = "邮箱") String email, @Schema(description = "部门ID") Long deptId,
							  @Schema(description = "岗位ID") Long jobId, @Schema(description = "头像") String avatar,
