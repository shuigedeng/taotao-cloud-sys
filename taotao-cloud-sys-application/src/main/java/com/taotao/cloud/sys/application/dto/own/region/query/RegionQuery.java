...
public record RegionQuery(@Schema(description = "地区编码") String code, @Schema(description = "地区名称") String name,
						  ...
						  @Schema(description = "地区父节点") Long parentId) implements Query {
