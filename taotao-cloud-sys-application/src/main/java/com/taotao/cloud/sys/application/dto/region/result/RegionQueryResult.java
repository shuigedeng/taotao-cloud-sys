...
package com.taotao.cloud.sys.application.dto.region.result;
...
public record RegionQueryResult(	@Schema(description = "地区编码")
	String code,
	...
	Long parentId) implements MarkerResult {
