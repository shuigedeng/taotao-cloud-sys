...
import com.taotao.cloud.sys.application.service.command.FileCommandService;
...
public class FileCommandServiceImpl implements FileCommandService {
    ...
    ////        return optionalFile.orElseThrow(() -> new
    ...
    ////
    ////        try {
    ////            file.setCreateTime(LocalDateTime.parse(ossInfo.getCreateTime(),
    // DatePattern.NORM_DATETIME_FORMATTER));
    ////            file.setUpdateTime(LocalDateTime.parse(ossInfo.getLastUpdateTime(),
    // DatePattern.NORM_DATETIME_FORMATTER));
